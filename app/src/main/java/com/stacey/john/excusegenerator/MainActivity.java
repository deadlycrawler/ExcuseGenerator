    ...
    public void addListenerOnButton1() {
        ...
        button1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               }else {generatedText.setText(col1[r1]+", "+col2[r2]+ ", "+col3[r3]);
               }
            ...
            public void onClick(View arg0) {
                ...
                if(creditCounter>=10){
                    creditText.setText("Congratulations on finding the secret credits!, either you love to just hit the credits button a lot or you already knew this was here, lets be honest it was Me." +
                            "i made this just in case someone didn't believe me that i made this program, looking at you ЖЕНЯ, so just so we are clear this was made by John Royal Stacey");
